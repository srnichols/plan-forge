...
# MCP server (if installed): exposes 14 forge tools as native MCP operations
# Key tools: forge_run_plan, forge_cost_report, forge_plan_status, forge_capabilities
# Dashboard: localhost:3100/dashboard (live progress, cost, session replay)
