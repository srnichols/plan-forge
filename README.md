...
## Dogfooding: Plan Forge Builds Plan Forge
...
- **v1.0 → v2.16** with zero manual rollbacks — every change flows through scope contracts, validation gates, and completeness sweeps
