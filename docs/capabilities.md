...
> **Tools**: 104 MCP (35 core + 14 LiveGuard + 2 Watcher + 8 Crucible + 6 Tempering + 4 Bug Registry + 3 Testbed + 3 Review + 2 Notify + 5 Lattice + 2 Memory + 2 Sync + 2 Forge-Master + 1 Doctor + 1 Worker Guardrails + 4 Auditor/Observer + ~11 newer tools) | **CLI mirrors**: Hallmark (`forge_hallmark_show|verify`, `pforge hallmark show|verify`), Anvil (`forge_anvil_stat|clear|rebuild|dlq_*`, `pforge anvil stat|clear|rebuild|dlq`) | **CLI**: 48+ commands | **Presets**: 9 | **Agents**: ~21 | **Skills**: ~12
>
