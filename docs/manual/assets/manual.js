...
(function () {
  ...
  const MANUAL_COUNTS = {
    // Pipeline / surface ────────────────────────────────────────────────
    tools:        102, // MCP TOOLS array length (capabilities snapshot toolCount) — tools.json is a curated subset (92) and lags; use: node -e "import('./pforge-mcp/server/tool-definitions.mjs').then(m=>console.log(m.TOOLS.length))"
