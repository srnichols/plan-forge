...
| 57 — LOCAL-RECALL | Zero-dependency semantic search over local `.forge/` thought stores: `forge_local_search` MCP tool (#089), TF-IDF + optional `@xenova/transformers` neural embeddings, persistent TF-IDF index cache (`.forge/local-recall-index.json`), ACI-compliant output. | 2026-05-19 | — |
