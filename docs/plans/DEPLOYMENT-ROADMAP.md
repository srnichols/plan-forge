...
- **Goal**: Fix all 127 ESLint error-severity violations surfaced by the Phase 42 audit (D-series: D1 complexity-error ×119, D2 max-lines-per-function-error ×8; D3 max-params-error already resolved by Phase 51/52 splits). Blocking — must ship before any A-series extraction begins.
- **Plan**: [Phase-43-CLEAN-CODE-ESLINT-ERRORS-PLAN.md](./Phase-43-CLEAN-CODE-ESLINT-ERRORS-PLAN.md)
