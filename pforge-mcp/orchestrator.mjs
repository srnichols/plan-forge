...
// ─── Model Scoring (Phase-53 S8) ─────────────────────────────────────
// Phase-53 S8: inferSliceType, recommendModel → orchestrator/model-scoring.mjs
// This extraction also resolves the cost-service.mjs ↔ orchestrator.mjs circular import:
// cost-service.mjs now imports these from ./orchestrator/model-scoring.mjs directly.
import {
  inferSliceType,
  recommendModel,
} from "./orchestrator/model-scoring.mjs";
export { inferSliceType, recommendModel };
// ─── Orchestrator ─────────────────────────────────────────────────────
