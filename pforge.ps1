...
function Get-VersionTargets {
    ...
    return @(
        ...
        [PSCustomObject]@{ File = "package.json";               Strategy = 'RegexReplace'; Pattern = '"version":\s*"[^"]+"';                  Replace = "`"version`": `"$newVersion`"";                                                                   Desc = "root package.json";         Optional = $false },
        ...
        [PSCustomObject]@{ File = "pforge-master/package.json"; Strategy = 'RegexReplace'; Pattern = '"version":\s*"[^"]+"';                  Replace = "`"version`": `"$newVersion`"";                                                                   Desc = "Forge-Master package.json"; Optional = $false },
