/**
 * Swift tempering adapter (Phase TEMPER-02 Slice 02.1 — stub)
 *
 * Intentionally unsupported in this slice. Extension opportunity
 * documented in docs/EXTENSIONS.md. A future extension should wrap
 * `swift test --parallel` plus an XCTest parser.
 */
