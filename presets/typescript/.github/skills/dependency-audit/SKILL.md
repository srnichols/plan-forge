...
description: Scan TypeScript/Node.js project dependencies for vulnerabilities, outdated packages, and license issues. Use before PRs, after adding packages, or on a regular schedule.
...
```
> **If this step fails** (no package.json found): Stop and report "No Node.js project found in this directory."
...
```
> **If this step fails** (license-checker not installed): Run `pnpm add -D license-checker` and retry.
...
- Run `pnpm test` after any dependency change
